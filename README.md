...
_A MVC web application for tracking orders for vendors._

## <span style="color:#0ec2b8">Setup/Installation Requirements</span>
### <span style="color:#c4f4ef">Open Locally</span>
1. _Navigate to my GitHub Pugsly99 to view the project files and commits.
2. _Click on the green button labeled "Code"_ to copy repository URL.
3. _Clone the repository to your local machine_ by opening your machine terminal and using the command "git clone https://github.com/Pugsly99/PierresTracker.git".
...
### <span style="color:#c4f4ef">Run Tests</span> 
 ...
 1. _Open Terminal, navigate into the "PierresTracker.Tests/" folder in the command line_ 
